  ...
  const items: NavItem[] = [
    ...
    { label: 'Clientes', icon: Contact, href: '/clientes', module: 'clientes' },
    {
      ...
      children: [
        ...
        { label: 'Rel. Atendentes', icon: FileBarChart, href: '/relatorios/atendentes', module: 'report_attendants' },
        { label: 'Rel. Agendamentos', icon: FileBarChart, href: '/relatorios/agendamentos', module: 'report_appointments' },
        { label: 'Rel. Comparecimento', icon: FileBarChart, href: '/relatorios/comparecimento', module: 'report_attendance' },
      ],
    },
